...
const primaryButtonClassName =
  "inline-flex items-center justify-center rounded-full bg-emerald-600 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-700";
...
const inconvenients = [
  "Les rendements ne sont pas garantis et peuvent changer à tout moment.",
  "Nexo reste une plateforme centralisée : l’utilisateur dépend d’un intermédiaire.",
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
          ...
          <div className="grid gap-10 lg:grid-cols-[1.5fr_0.8fr] lg:items-center">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                ...
                <Link
                  href="/crypto"
                  className="inline-flex items-center justify-center rounded-full border border-slate-200 bg-white px-6 py-3 text-sm font-semibold text-slate-800 shadow-sm transition hover:border-emerald-300 hover:text-emerald-700"
                >
      ...
      <section className="mx-auto grid max-w-6xl gap-8 px-6 py-14 lg:grid-cols-[1fr_320px]">
        <div className="space-y-10">
          ...
          <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            ...
            <div className="mt-6 grid gap-4">
              {avantages.map((avantage) => (
                <div
                  key={avantage}
                  className="rounded-2xl border border-emerald-100 bg-emerald-50 p-4 text-slate-700"
                >
          ...
          <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            ...
            <div className="mt-6 grid gap-4">
              {inconvenients.map((inconvenient) => (
                <div
                  key={inconvenient}
                  className="rounded-2xl border border-amber-200 bg-amber-50 p-4 text-slate-700"
                >
          ...
          <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            <h2 className="text-2xl font-bold text-slate-950">FAQ sur Nexo</h2>
