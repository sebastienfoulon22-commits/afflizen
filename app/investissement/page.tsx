const platforms = [
  {
    ...
    description:
      "Application d’investissement pour accéder simplement aux actions, ETF et autres produits financiers.",
    bonus: "À vérifier",
  },
];
      ...
      <section className="border-b border-slate-200 bg-gradient-to-b from-white to-emerald-50">
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <h1 className="mt-3 text-4xl font-bold tracking-tight md:text-5xl">
            Applications d’investissement, actions, ETF et plateformes pour débuter
          </h1>

          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
            Comparez les plateformes d’investissement suivies par Afflizen :
            avantages, limites, frais éventuels, conditions, bonus possibles et
            avis pratique avant inscription.
          </p>
        </div>
      </section>
