    ...
    <main className="min-h-screen bg-white text-slate-950">
      <section className="border-b border-slate-200 bg-gradient-to-b from-white to-emerald-50">
        <div className="mx-auto max-w-6xl px-6 py-16">
          <p className="text-sm font-semibold text-emerald-600">Banques</p>

          <h1 className="mt-3 text-4xl font-bold tracking-tight md:text-5xl">
            Banques en ligne avec primes, cartes et comptes mobiles
          </h1>

          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
            Comparez les banques en ligne et applications financières suivies
            par Afflizen : avantages, limites, offres éventuelles, conditions et
